...
- [x] OTA: first-time install permission loses the download — Manager — f269f8b, IT verified OK. Deny-path edge case fixed after that, waiting for a quick IT recheck
