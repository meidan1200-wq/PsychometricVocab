...
- [ ] **C. `feature/home-redesign`** (d37dd05, includes A+B; IT OK 16/16 plus A+B sanity; waiting for the owner to review screenshots, then QA), owner spec in DECISIONS 2026-09-24: remove the quick actions that duplicate the bottom bar; calmer, fewer colors. The Developer sends design options and the owner picks before any code — Developer
